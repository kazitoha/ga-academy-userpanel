        ...
        <div class="row">
            ...
            <div class="col-lg-4">
              <div class="useful-link">
                  <h3>Teacher & Staff </h3>
                  <ul>
                    <li ><a href="<?php echo e(url('/teacher&staff')); ?>"><b <?php if($url =="teacher&staff"): ?> style="color:red" <?php endif; ?>>All</b></li>
                      <li ><a href="<?php echo e(url('select/office/1')); ?>"><b <?php if($id ==1): ?> style="color:red" <?php endif; ?>>Teacher</b></a></li>
                      <li ><a href="<?php echo e(url('select/office/2')); ?>"><b <?php if($id==2): ?> style="color:red" <?php endif; ?>>Staff</b></a></li>
...
<?php echo $__env->make('userview/layout/navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\school-userpanel\ga-academy-userpanel\resources\views/userview/staff/staff.blade.php ENDPATH**/ ?>