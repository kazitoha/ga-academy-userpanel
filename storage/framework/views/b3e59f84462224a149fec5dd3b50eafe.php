...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('admin_asset/assets/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public_asset/css/font-awesome.min.css')); ?>">
    <!-- main css link-------- -->
            ...
            <div class="row">
                ...
                <div class="col-8 text-center m-auto">
                    <span class="mb-0 mt-2"
                        style="color:#666666; font-weight: bold; <?php if(strlen(websiteSetting()->school_name) <= 50): ?> font-size: 29px; <?php else: ?> font-size: 26px; <?php endif; ?> ">
                        <?php if(!empty(websiteSetting())): ?>
                            <?php echo e(websiteSetting()->school_name); ?>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="footer-top-one">
                        ...
                        <div class="footer-link">
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('contact')); ?>"><i class="fa fa-map-marker"
                                            aria-hidden="true"></i>
                                        <?php if(!empty(websiteSetting())): ?>
                                            <?php echo e(websiteSetting()->address); ?>
                                ...
                                <li>
                                    <strong><a href=""><i class="fa fa-envelope-o" aria-hidden="true"></i>
                                            <?php if(!empty(websiteSetting())): ?>
                                                <?php echo e(websiteSetting()->email); ?>

                                            <?php else: ?>
                                                <?php echo e('School@email.com'); ?>
...
<?php /**PATH D:\laragon\www\ga-academy-userpanel\resources\views/userview/layout/navbar.blade.php ENDPATH**/ ?>