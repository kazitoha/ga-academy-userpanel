...
<!-- header part finish -->
  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky_top">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="<?php echo e(asset('public_asset/images/logo.jpg')); ?>" alt="" class="img-fluid" style="width: 79px;"></a>
      ...
      <div class="collapse navbar-collapse justify-content-md-right" id="navbarNavDropdown">
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($url == 'teacher&staff' || $url=='select/office/{id}'): ?> active <?php endif; ?>" href="<?php echo e(route('teacher')); ?>">Teacher & Staff</a>
          </li>
