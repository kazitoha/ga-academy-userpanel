    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="custom-validation" action="<?php echo e(route('staff.store')); ?>" method="post" enctype="multipart/form-data" novalidate>
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" aria-label="Default select example" name="select_category" required>
