            ...
            <div class="row">
                <div class="blog-content col-lg-9 col-md-6 md-pt-0">
                    ...
                    <div class="content-items" id="showCourseFinder">
                        ...
                        <h4 class="text-center">Total <span class="badge badge-secondary"><?php echo e($all_event->count()); ?></span>
                            Events</h4>
                        <div class="row">
                                    ...
                                    <div class="item">
                                        <div class="info">
                                            <div class="content">
                                                ...
                                                <a href="<?php echo e(route('single.event', $value->slug)); ?>" class="btn-read">+ read
                                                    more....</a>
                                            </div>
                                        </div>
                                    </div>
