            ...
            <div class="row">
                <div class="blog-content col-lg-12 col-md-6 md-pt-5">
                    ...
                    <div class="content-items" id="showCourseFinder">
                        ...
                        <h4 class="text-center">Total <span class="badge badge-secondary">{{$all_event->count()}}</span> Events</h4>
                    <div class="row">
                                ...
                                <div class="info">
                                    <div class="content">
                                        <h4>{{$value->event_name}}</h4>
                                            <a href="{{route('single.event', base64_encode($value->id))}}" class="btn-read">+ read more....</a>
                                    </div>
                                </div>
                            </div>
                        </div>
