      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="latest-news-heading">
                <h3>About @if($id ==1) Science @elseif($id==2) Business Studies  @elseif($id==3) Humanities @endif  Teachers</h3>
                <span><a href="{{ url('teachers') }}">Refresh<i class="fas fa-redo-alt"></i></a></span>
            </div>
        </div>
    </div><br>
        <div class="row">
            ...
            <div class="col-lg-4">
              <div class="useful-link">
                  <h3>Teacher & Staff </h3>
                  <ul>
                      <li><a href="{{ url('/select/teacher/1') }}"><b @if($id ==1) style="color:red" @endif>Science Teachers</b></li>
                      <li ><a href="{{ url('select/teacher/2')}}"><b @if($id ==2) style="color:red" @endif>Business Studies Teachers</b></a></li>
                      <li ><a href="{{ url('select/teacher/3')}}"><b @if($id==3) style="color:red" @endif>Humanities Teachers</b></a></li>
                  </ul>
              </div>
          </div>
        </div>
