...
@section('adminpanel-navbar')
    <div class="row">
        <div class="container">
            <h4 class="float-left">News List</h4>
                            ...
                            <table id="tech-companies-1" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-priority="1">News Date</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a target="_blank"
                                                        href="https://www.facebook.com/sharer/sharer.php?u=https://fenigaacademy.edu.bd/public/single/news/{{ base64_encode($value->id) }}"
                                                        class="btn btn-primary">Share</a>
                                                    <a href="{{ route('news.edit', base64_encode($value->id)) }}"
                                                        class="btn btn-info ">Edit</a>
                                                    <a href="{{ route('news.delete', base64_encode($value->id)) }}"
