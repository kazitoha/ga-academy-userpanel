    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title">Committee Member List</h4>
                        ...
                        <tr> 
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                  <a href="{{route('committee.edit',base64_encode($value->id))}}" class="btn btn-info">Edit</a>
                                  <a href="{{route('committee.delete',base64_encode($value->id))}}" class="btn btn-secondary" onclick="return checkDelete()">Delete</a>
                                </div>
                            </td>
                        </tr>
                      @empty
