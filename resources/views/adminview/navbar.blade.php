...
<head>
    ...
    <link href="{{asset('admin_asset/assets/libs/slick-slider/slick/slick-theme.css')}}" rel="stylesheet" type="text/css" />
        ...
        <header id="page-topbar">
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="{{asset('public_asset/images/logo.jpg')}}" alt="" style="width: 76px; height: 69px;" >
                            </span>
                        </a>

                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{asset('public_asset/images/logo.jpg')}}" alt="" style="width: -1px;height: 28px;">
                            </span>
                            <span class="logo-lg">
                                <img src="{{asset('public_asset/images/logo.jpg')}}" alt="" style="width: 73px; height: 64px;">
                            </span>
                        </a>
                    </div>
             ...
             <div class="dropdown d-inline-block">
                     ...
                     <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                         data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <img class="rounded-circle header-profile-user" src="{{asset('admin_asset/assets/images/users/avatar-1.jpg')}}"
                             alt="Header Avatar">
                         <span class="d-none d-sm-inline-block ml-1">{{ Auth::user()->name }}</span>
                         <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                     </button>               @endif                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-right d-none d-sm-block">
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="#">MagpieTeam</a>
                            </div>
                        </div>
                    </div>
                </div>
